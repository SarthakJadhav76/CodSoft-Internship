...
class PasswordGeneratorApp:
    def __init__(self, master):
        ...
        self.title_label = tk.Label(master, text="Password Generator", font=("Helvetica", 14, "bold"), bg="#f0f0f0")
        ...
        self.create_button = tk.Button(master, text="Create Password", bd=5, height=2, command=self.generate_password, font=("Helvetica", 12, "bold"), bg="#ff0000", fg="white")
        self.create_button.pack(pady=(20, 10))

        self.copy_button = tk.Button(master, text="Copy Password", bd=5, height=2, command=self.copy_to_clipboard, font=("Helvetica", 12, "bold"), bg="#0000ff", fg="white")
